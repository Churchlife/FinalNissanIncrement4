...
namespace NissanCartTest01.WebUi.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<Parts> Partst { get; set; }

        public DbSet<Orders> Orderst { get; set; }

        public DbSet<Category> Categories { get; set; }
        public DbSet<VehCat> VehCats { get; set; }
        ...
        public DbSet<VehicleForSale> VehicleForSales { get; set; }
